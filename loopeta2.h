...
// Wed Nov 17 12:08:46 2021 by ROOT version 6.22/06
// from TTree nteta2/pp_eta2
// found on file: pp_ppeta2.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TBranch        *b_minvee;
   TBranch        *b_minveepp;
   TBranch        *b_minveepipi;
   TBranch        *b_minvpp;
   TBranch        *b_minvpipi;

   loopeta2(TTree *tree=0);
   virtual ~loopeta2();
...
#ifdef loopeta2_cxx
loopeta2::loopeta2(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("pp_ppeta2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("pp_ppeta2.root");
      }
      f->GetObject("nteta2",tree);
...
Int_t loopeta2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t loopeta2::LoadTree(Long64_t entry)
{
...
void loopeta2::Show(Long64_t entry)
{
...
Int_t loopeta2::Cut(Long64_t entry)
{
